...
and Flower :substitution-code:`|latest_version_docker|`:
...
.. code-block:: bash
   ...
   $ docker build \
     ...
     --build-arg FLWR_VERSION=|latest_version_docker| \
...
.. list-table::
   ...
   * - ``BASE_IMAGE``
     ...
     - Yes
     - :substitution-code:`|latest_version_docker|-py3.10-ubuntu|ubuntu_version|`
